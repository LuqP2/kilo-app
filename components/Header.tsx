            ...
            <div className="flex items-center gap-2 sm:gap-4">
              ...
              {!currentUser ? (
                <button
                  ...
                  className="px-4 py-2 text-sm font-semibold rounded-md text-white bg-orange-600 hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 transition-colors"
                >
                  Entrar
                </button>
              ) : (
